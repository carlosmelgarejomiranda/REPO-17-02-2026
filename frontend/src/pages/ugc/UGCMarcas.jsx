    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-6 bg-[#0d0d0d]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a 
            href="https://wa.me/595976691520?text=Hola!%20Estoy%20interesado%20en%20UGC%20para%20mi%20marca.%20%C2%BFPodr%C3%ADan%20darme%20m%C3%A1s%20informaci%C3%B3n%3F"
            target="_blank"
            ...
            data-testid="whatsapp-direct-cta"
          >
