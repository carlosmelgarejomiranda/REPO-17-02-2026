    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0d0d0d' }}>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
          ...
          >
            {sl.title || 'Avenue Studio'}
          </h1>
          <p 
            className="text-xl md:text-2xl mb-4 font-light"
            style={{ color: '#d4a968' }}
          >
            {sl.subtitle || 'Donde el contenido cobra vida'}
          </p>
          <p 
            className="text-base md:text-lg max-w-3xl mx-auto leading-relaxed"
            style={{ color: '#a8a8a8' }}
          >
            {sl.description || 'Un espacio profesional para crear contenido de alta calidad y conectar marcas con creadores'}
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h2 
                ...
                style={{ color: '#f5ede4', fontFamily: 'var(--font-primary)' }}
              >
                {sl.rental || 'Alquiler de estudio'}
              </h2>
              <p className="mb-6 text-center" style={{ color: '#a8a8a8' }}>
                {sl.rentalDesc || 'Estudio fotográfico profesional equipado con luces Godox, fondo infinito, área de descanso y más'}
              </p>
              ...
              <div className="flex items-center justify-center gap-2" style={{ color: '#d4a968' }}>
                <span className="font-medium">{sl.viewMore || 'Ver más y reservar'}</span>
            ...
            >
              ...
              <h2 
                ...
                style={{ color: '#f5ede4', fontFamily: 'var(--font-primary)' }}
              >
                {sl.ugcTitle || 'UGC Creators'}
              </h2>
              <p className="mb-6 text-center" style={{ color: '#a8a8a8' }}>
                {sl.ugcDesc || 'Conectamos marcas con microinfluencers para crear contenido auténtico a cambio de canjes'}
              </p>
              
              {/* Benefits */}
              <div className="space-y-3 mb-6">
                {[
                  sl.ugcBenefit1 || 'Contenido UGC auténtico',
                  sl.ugcBenefit2 || 'Microinfluencers verificados',
                  sl.ugcBenefit3 || 'Canjes de productos/servicios',
                  sl.ugcBenefit4 || 'Campañas personalizadas',
                ].map((item, i) => (
                  <div 
                    key={i}
                    className="p-3 rounded text-center"
              ...
              <div className="flex items-center justify-center gap-2" style={{ color: '#d4a968' }}>
                <span className="font-medium">{sl.knowMore || 'Conocer más'}</span>
                <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-2" />
              </div>
            </a>
          </div>
      ...
      <div className="pb-12 text-center">
        <a 
          ...
          style={{ color: '#666' }}
        >
          ← {sl.backToAvenue || 'Volver a Avenue'}
        </a>
      </div>
    </div>
  );
