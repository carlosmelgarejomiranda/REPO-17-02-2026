...
import { 
  ...
  MessageSquare, TrendingUp, Package, ChevronRight, ChevronDown, Shield, Heart,
  ...
  exhibidores: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['2 Exhibidores en Showroom', '8 Reels producidos por mes', '30 fotos de estudio mensuales', '4 horas de estudio incluidas', 'Campaña UGC Standard con 12 materiales', '4 posteos en redes'],
        highlight: true,
        isPro: true
      }
    ]
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-white/50 text-sm">
              {formStep === 1 ? 'Completá tus datos para continuar' : 'Respondé el cuestionario para entender mejor tus necesidades'}
            </p>
          </div>
          ...
          {formStep === 1 ? (
              ...
              {selectedPlan && (
                <div className="bg-[#d4a968]/10 border border-[#d4a968]/30 rounded-lg p-3 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-white/50 text-xs ml-2">({formatPrice(selectedPlan.price)} Gs/mes)</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end pt-2">
                      <button
                        type="button"
                        onClick={() => {
                          if (formData.brand_name && formData.contact_name && formData.email && formData.interest) {
                            setFormStep(2);
                          } else {
            ...
            <div className="space-y-3">
              ...
              <MultiSelectDropdown
                question="2) ¿Qué querés lograr en los próximos 90 días?"
              ...
              {/* Q3: Obstáculo */}
              <MultiSelectDropdown
                question="3) ¿Qué obstáculo te frena hoy?"
                subtitle="Seleccioná hasta 3 opciones"
                options={opcionesObstaculo}
                selected={q3Obstaculo}
                setSelected={setQ3Obstaculo}
                max={3}
              />

              {/* Q4: Prioridad en AVENUE */}
              <MultiSelectDropdown
                question="4) ¿Qué te interesa priorizar en AVENUE?"
                subtitle="Seleccioná hasta 3 opciones"
                options={opcionesPrioridad}
                selected={q4Prioridad}
                setSelected={setQ4Prioridad}
                max={3}
              />
              ...
              <div className="border border-white/10 rounded-xl overflow-hidden">
                <div className="px-4 py-3 bg-white/5">
                  <p className="text-white font-medium text-sm">6) Expectativa principal + contexto</p>
                  <p className="text-white/40 text-xs mt-0.5">¿Qué esperás de AVENUE? Contanos tu prioridad y cualquier info relevante</p>
                </div>
                <div className="p-3 border-t border-white/10">
                  <textarea
                    ...
                    placeholder="Categoría, ticket promedio, stock, links, metas, restricciones..."
                  />
                </div>
              </div>
      ...
      <section className="py-16 px-6 bg-[#0d0d0d]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a 
            href="https://wa.me/595976691520?text=Hola!%20Me%20interesa%20saber%20m%C3%A1s%20sobre%20c%C3%B3mo%20mi%20marca%20puede%20estar%20en%20Avenue"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold rounded-xl transition-all transform hover:scale-105 shadow-lg shadow-[#25D366]/20"
