              ...
              <section className="bg-white p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm text-gray-600">Necesito factura con RUC</span>
                  </label>
                </div>
                ...
                {!needsInvoice && (
                  <p className="text-sm text-gray-500">
                    Se emitirá factura a consumidor final. Si necesitás factura con RUC, marcá la opción de arriba.
                  </p>
                )}
              </section>
            </div>
